...
public class config {
    ...
    public List<Course> CourseRepository(CourseRepo repoCourse, List<Adresse> adresseList, Utilisateur user)
    {
        ...
        Course course1 = new Course(1,"Course d'Halloween",5.50,new Date(2022,05,30),new Time(10,35,00) ,adresseList.get(1),adresseList.get(0),user);
        ...
        Course course2 = new Course(2,"Course de Noel",10,new Date(2023,10,30),new Time(10,35,00),adresseList.get(2),adresseList.get(2),user);
        ...
        Course course3 = new Course(3,"Charleroi-Chatelet",20.5,new Date(2023,12,30),new Time(10,35,00),adresseList.get(2),adresseList.get(1),user);
